...
namespace Ambit.AppCore.EntityModels
{
	...
	public class JDatatableResult<T>
	{
		/// <summary>
	...
	/// </summary>
	public abstract class JDatatableRow
	{
		/// <summary>
	...
	public class JDatatableParameters
	{
		...
		/// </summary>
		public JDatatableColumn[] Columns { get; set; }
		...
		/// </summary>
		public JDatatableOrder[] Order { get; set; }
		...
		/// </summary>
		public JDatatableSearch Search { get; set; }
		...
		public string SortOrder => Columns != null && Order != null && Order.Length > 0
			? (Columns[Order[0].Column].Data +
			  (Order[0].Dir == JDatatableOrderDir.Desc ? " " + Order[0].Dir : string.Empty))
			: null;
		...
		public string OrderByDirection
		{
			...
			{
				if (Order != null)
					return Order[0].Dir.ToString().ToLower() == "asc" ? "ASC" : "DESC";
				else
					return null;
			}
		}
		...
		public bool OrderByAscending
		{
			...
			{
				if (Order != null)
					return Order[0].Dir.ToString().ToLower() == "asc";
				else
					return false;
			}
		}
	...
	public class JDatatableOrder
	{
		...
		/// </summary>
		public JDatatableOrderDir Dir { get; set; }
	}

	/// <summary>
	/// Sort orders of jQuery DataTables.
	/// </summary>
	public enum JDatatableOrderDir
	{
		Asc,
		Desc
	}
